...
var VariometerFragment = /** @class */ (function () {
    ...
    VariometerFragment.prototype.drawRulerSteps = function (mainStepPixels, stepValue, zeroOffsetV, triangleSize) {
        ...
        while (offsetV >= 0 && offsetV < this.currentHudBounds.height) {
            ...
            // second step (A)
            this.hudComponent.hudBitmap.moveTo(this.currentHudBounds.min.x + triangleSize.width + 1, this.currentHudBounds.min.y + offsetV - mainStepPixels * 0.3333);
            this.hudComponent.hudBitmap.lineTo(this.currentHudBounds.min.x + triangleSize.width + 1 + 16, this.currentHudBounds.min.y + offsetV - mainStepPixels * 0.3333);
            // second step (B)
            this.hudComponent.hudBitmap.moveTo(this.currentHudBounds.min.x + triangleSize.width + 1, this.currentHudBounds.min.y + offsetV - mainStepPixels * 0.6666);
            this.hudComponent.hudBitmap.lineTo(this.currentHudBounds.min.x + triangleSize.width + 1 + 16, this.currentHudBounds.min.y + offsetV - mainStepPixels * 0.6666);
            // Third step (first)
            this.hudComponent.hudBitmap.moveTo(this.currentHudBounds.min.x + triangleSize.width + 1, this.currentHudBounds.min.y + offsetV - mainStepPixels * 0.1667);
            this.hudComponent.hudBitmap.lineTo(this.currentHudBounds.min.x + triangleSize.width + 1 + 8, this.currentHudBounds.min.y + offsetV - mainStepPixels * 0.1667);
            // Third step (second)
            ...
            this.hudComponent.hudBitmap.lineTo(this.currentHudBounds.min.x + triangleSize.width + 1 + 8, this.currentHudBounds.min.y + offsetV - mainStepPixels * 0.5);
            // Third step (third)
            this.hudComponent.hudBitmap.moveTo(this.currentHudBounds.min.x + triangleSize.width + 1, this.currentHudBounds.min.y + offsetV - mainStepPixels * 0.6667);
            this.hudComponent.hudBitmap.lineTo(this.currentHudBounds.min.x + triangleSize.width + 1 + 8, this.currentHudBounds.min.y + offsetV - mainStepPixels * 0.6667);
            // Third step (fourth)
            this.hudComponent.hudBitmap.moveTo(this.currentHudBounds.min.x + triangleSize.width + 1, this.currentHudBounds.min.y + offsetV - mainStepPixels * 0.8333);
            this.hudComponent.hudBitmap.lineTo(this.currentHudBounds.min.x + triangleSize.width + 1 + 8, this.currentHudBounds.min.y + offsetV - mainStepPixels * 0.8333);
        } // END while
        this.hudComponent.hudBitmap.closePath();
        this.hudComponent.hudBitmap.stroke();
        var i = 0;
