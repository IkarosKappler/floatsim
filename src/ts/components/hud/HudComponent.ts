...
import { DepthMeterFragment } from "./DepthMeterFragment";
import { LowerInfoHudFragment } from "./LowerInfoHudFragment";
import { VariometerFragment } from "./VariometerFragment";
